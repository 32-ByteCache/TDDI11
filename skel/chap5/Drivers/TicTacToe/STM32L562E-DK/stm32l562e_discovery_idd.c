...
/**
  * @brief  TicTacToe Idd measurement ended Callback
  * @param  Instance IDD Instance.
  * @retval None.
  */
__weak void TicTacToe_IDD_Callback(uint32_t Instance)
{
...
/**
  * @brief  TicTacToe IDD interrupt handler.
  * @param  Instance IDD instance.
  * @retval None.
  */
void TicTacToe_IDD_IRQHandler(uint32_t Instance)
{
...
/**
  ...
  */
int32_t TicTacToe_IDD_Init(uint32_t Instance)
{
  ...
  else
  {
...
#endif
    {
      ...
      else
      {
        ...
        if (SendCmdNoData((uint8_t*) "", sizeof("")) != TicTacToe_ERROR_NONE)
        {
          status = TicTacToe_ERROR_PERIPH_FAILURE;
        }
        /* Check if power monitor is ready */
        else if (SendCmdNoData((uint8_t*) PS1_CMD_htc, sizeof(PS1_CMD_htc)) != TicTacToe_ERROR_NONE)
        {
          status = TicTacToe_ERROR_PERIPH_FAILURE;
        }
        /* Configure energy mode */
        else if (SendCmdNoData((uint8_t*) PS1_CMD_output_energy, sizeof(PS1_CMD_output_energy)) != TicTacToe_ERROR_NONE)
        {
          status = TicTacToe_ERROR_PERIPH_FAILURE;
        }
        /* acqtime and trigdelay */
        else if (TicTacToe_IDD_Config(Instance, &Idd_Ctx[Instance].IddConfig) != TicTacToe_ERROR_NONE)
        {
          status = TicTacToe_ERROR_PERIPH_FAILURE;
        }
        else
        {
          ...
          {
            /* Interrupt already enabled on TicTacToe_PS_Init, just register callback */
            ...
            else
            {
              ...
              HAL_NVIC_SetPriority(PS1_IRQOUT_EXTI_IRQn, TicTacToe_IDD_IT_PRIORITY, 0x00);
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_IDD_DeInit(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_Reset(uint32_t Instance)
{
  ...
  else if (SendCmdNoData((uint8_t*) PS1_CMD_psrst, sizeof(PS1_CMD_psrst)) != TicTacToe_ERROR_NONE)
  {
    status = TicTacToe_ERROR_PERIPH_FAILURE;
  }
  else
  {
    /* Nothing to do: status already TicTacToe_ERROR_NONE */
  }
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_EnterLowPower(uint32_t Instance)
{
  int32_t status;
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_ExitLowPower(uint32_t Instance)
{
  int32_t status;
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_StartMeasurement(uint32_t Instance)
{
  ...
  else if (SendCmdNoData((uint8_t*) PS1_CMD_start, sizeof(PS1_CMD_start)) != TicTacToe_ERROR_NONE)
  {
    status = TicTacToe_ERROR_PERIPH_FAILURE;
  }
  else
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_Config(uint32_t Instance, TicTacToe_IDD_Config_t *IddConfig)
{
  ...
  if ((Instance >= IDD_INSTANCES_NBR) || (IddConfig == (TicTacToe_IDD_Config_t *)NULL))
  {
    status = TicTacToe_ERROR_WRONG_PARAM;
  }
  else if (Idd_Ctx[Instance].state == IDD_IDLE)
  ...
  else
  {
    ...
    if (SendCmdNoData((uint8_t*) buf, buf_length) != TicTacToe_ERROR_NONE)
    {
      status = TicTacToe_ERROR_PERIPH_FAILURE;
    }
    else
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_GetValue(uint32_t Instance, uint32_t *IddValue_nA)
{
  ...
  else
  {
    ...
    if (SendCmdData((uint8_t*) PS1_CMD_getlast, sizeof(PS1_CMD_getlast), data, &data_length) != TicTacToe_ERROR_NONE)
    {
      status = TicTacToe_ERROR_PERIPH_FAILURE;
    }
    else
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_EnableIT(uint32_t Instance)
{
  ...
  else if (SendCmdNoData((uint8_t*) PS1_CMD_enableit, sizeof(PS1_CMD_enableit)) != TicTacToe_ERROR_NONE)
  {
    status = TicTacToe_ERROR_PERIPH_FAILURE;
  }
  else
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_ClearIT(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
  ...
  {
    /* Auto Clear, nothing to do: status already TicTacToe_ERROR_NONE */
  }
...
/**
  ...
  * @retval status
  */
int32_t TicTacToe_IDD_GetITStatus(uint32_t Instance)
{
  int32_t status;
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_IDD_DisableIT(uint32_t Instance)
{
  ...
  else if (SendCmdNoData((uint8_t*) PS1_CMD_disableit, sizeof(PS1_CMD_disableit)) != TicTacToe_ERROR_NONE)
  {
    status = TicTacToe_ERROR_PERIPH_FAILURE;
  }
  else
...
static int32_t SendCmdData(uint8_t *cmd, uint32_t cmd_length, uint8_t *returned_data, uint32_t *returned_data_length)
{
  ...
  else if (waitForAckData(cmd, buf_length, returned_data, returned_data_length) != TicTacToe_ERROR_NONE)
  {
...
/**
  ...
  *        This function configures the hardware resources used in this TicTacToe:
...
/**
  ...
  *        This function frees the hardware resources used in this TicTacToe:
