/**
  ******************************************************************************
  * @file    stm32l562e_discovery_motion_sensors.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32l562e_discovery_motion_sensors.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32L562E_DISCOVERY_MOTION_SENSORS_H
#define STM32L562E_DISCOVERY_MOTION_SENSORS_H
...
/** @addtogroup STM32L562E-DK_MOTION_SENSORS
  * @{
  */

/** @defgroup STM32L562E-DK_MOTION_SENSORS_Exported_Types STM32L562E-DK MOTION_SENSOR Exported Types
  * @{
  */
/* Motion sensor axes */
typedef struct
{
  ...
  int32_t y;
  int32_t z;
} TicTacToe_MOTION_SENSOR_Axes_t;
...
typedef struct
{
  ...
  int16_t y;
  int16_t z;
} TicTacToe_MOTION_SENSOR_AxesRaw_t;
...
/** @defgroup STM32L562E-DK_MOTION_SENSORS_Exported_Constants STM32L562E-DK MOTION_SENSOR Exported Constants
  * @{
  */
/* One motion sensor is mounted on the STM32L562E-DK board,
...
/** @addtogroup STM32L562E-DK_MOTION_SENSORS_Exported_Variables
  * @{
  */
...
/** @defgroup STM32L562E-DK_MOTION_SENSORS_Exported_Functions STM32L562E-DK MOTION_SENSOR Exported Functions
  * @{
  */
...
#endif /* STM32L562E_DISCOVERY_MOTION_SENSORS_H */
