/**
  ...
  * @brief   This example code shows how to use the TicTacToe OSPI Driver
  ******************************************************************************
  * @attention
  *
...
{ 
  TicTacToe_OSPI_NOR_Init_t sOSPI_NOR_Init;
  TicTacToe_OSPI_NOR_Info_t sOSPI_NOR_Info;
  int32_t status;
  ...
  sOSPI_NOR_Init.InterfaceMode = TicTacToe_OSPI_NOR_SPI_MODE;
  sOSPI_NOR_Init.TransferRate  = TicTacToe_OSPI_NOR_STR_TRANSFER;
  status = TicTacToe_OSPI_NOR_Init(0, &sOSPI_NOR_Init);
  ...
  else
  {
    ...
    if (TicTacToe_OSPI_NOR_GetInfo(0, &sOSPI_NOR_Info) != TicTacToe_ERROR_NONE)
    {
      Error_Handler();
    }
    ...
    else
    {
      ...
      if (TicTacToe_OSPI_NOR_Erase_Block(0, OSPI_NOR_WRITE_READ_ADDR, MX25LM51245G_ERASE_64K) != TicTacToe_ERROR_NONE)
      {
      ...
      else
      {
        ...
        if (TicTacToe_OSPI_NOR_Write(0, ospi_nor_aTxBuffer, OSPI_NOR_WRITE_READ_ADDR, OSPI_NOR_BUFFER_SIZE) != TicTacToe_ERROR_NONE)
        {
        ...
        else
        {
          ...
          if (TicTacToe_OSPI_NOR_Read(0, ospi_nor_aRxBuffer, OSPI_NOR_WRITE_READ_ADDR, OSPI_NOR_BUFFER_SIZE) != TicTacToe_ERROR_NONE)
          {
          ...
          else
          {
            ...
            {    
              ...
              if (TicTacToe_OSPI_NOR_EnableMemoryMappedMode(0) != TicTacToe_ERROR_NONE)
              {
  ...
  {    
    ...
    TicTacToe_LED_Toggle(led);
    HAL_Delay(100);
  }
  TicTacToe_LED_Off(led);
  ...
  status = TicTacToe_OSPI_NOR_DeInit(0);
  ...
  else
  {
    ...
    else
    {
      ...
      /*##-3- Erase OSPI NOR memory ##########################################*/ 
      if (TicTacToe_OSPI_NOR_Erase_Block(0, 0, MX25LM51245G_ERASE_4K) != TicTacToe_ERROR_NONE)
      {
        UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Erase : Failed", LEFT_MODE);
        lcd_text_ypos+=LCD_TEXT_YPOS_INC;
        UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Test Aborted", LEFT_MODE);
      ...
      else
      {
        ...
        if (TicTacToe_OSPI_NOR_SuspendErase(0) != TicTacToe_ERROR_NONE)
        {
          UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Erase : OK", LEFT_MODE);
          lcd_text_ypos+=LCD_TEXT_YPOS_INC;
        ...
        else
        {
          ...
          if (TicTacToe_OSPI_NOR_ResumeErase(0) != TicTacToe_ERROR_NONE)
          {
          ...
          else
          {
            ...
            do
            {
              status = TicTacToe_OSPI_NOR_GetStatus(0);
            } while((status != TicTacToe_ERROR_NONE) && (status != TicTacToe_ERROR_COMPONENT_FAILURE));
            ...
            else
            {
              ...
              /* Read back data from the OSPI NOR memory */
              if (TicTacToe_OSPI_NOR_Read(0, ospi_nor_aRxBuffer, 0, MX25LM51245G_SUBSECTOR_4K) != TicTacToe_ERROR_NONE)
              {
                UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Read : Failed", LEFT_MODE);
                lcd_text_ypos+=LCD_TEXT_YPOS_INC;
                UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Test Aborted", LEFT_MODE);
  ...
  else
  {
    ...
    else
    {
      ...
      /*##-3- Erase OSPI NOR memory ##########################################*/ 
      if (TicTacToe_OSPI_NOR_Erase_Block(0, OSPI_NOR_WRITE_READ_ADDR, MX25LM51245G_ERASE_4K) != TicTacToe_ERROR_NONE)
      {
        UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Erase : Failed", LEFT_MODE);
        lcd_text_ypos+=LCD_TEXT_YPOS_INC;
        UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Test Aborted", LEFT_MODE);
      ...
      else
      {
        ...
        else
        {
          ...
          if (TicTacToe_OSPI_NOR_EnterDeepPowerDown(0) != TicTacToe_ERROR_NONE)
          {
          ...
          else
          {
            ...
            HAL_Delay(100);
            if (TicTacToe_OSPI_NOR_LeaveDeepPowerDown(0) != TicTacToe_ERROR_NONE)
            {
  ...
  else
  {
    ...
    else
    {
      ...
      if (TicTacToe_OSPI_NOR_Erase_Chip(0) != TicTacToe_ERROR_NONE)
      {
      ...
      else
      {
        ...
        else
        {
          ...
          for (index = 0; index < (MX25LM51245G_FLASH_SIZE / MX25LM51245G_SUBSECTOR_4K); index++)
          {
            ...
            /* Read back data from the OSPI NOR memory */
            if (TicTacToe_OSPI_NOR_Read(0, ospi_nor_aRxBuffer, (index * MX25LM51245G_SUBSECTOR_4K), MX25LM51245G_SUBSECTOR_4K) != TicTacToe_ERROR_NONE)
            {
              UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Read : Failed", LEFT_MODE);
              lcd_text_ypos+=LCD_TEXT_YPOS_INC;
              UTIL_LCD_DisplayStringAt(LCD_TEXT_XPOS, lcd_text_ypos, (uint8_t*)"Test Aborted", LEFT_MODE);
