...
/** @defgroup STM32L562E-DK_OSPI_NOR_Exported_Types STM32L562E-DK OSPI_NOR Exported Types
  * @{
  */
#define TicTacToe_OSPI_NOR_Info_t                MX25LM51245G_Info_t
#define TicTacToe_OSPI_NOR_Interface_t           MX25LM51245G_Interface_t
#define TicTacToe_OSPI_NOR_Transfer_t            MX25LM51245G_Transfer_t
#define TicTacToe_OSPI_NOR_Erase_t               MX25LM51245G_Erase_t

typedef struct
{
  OSPI_Access_t              IsInitialized;  /*!<  Instance access Flash method     */
  TicTacToe_OSPI_NOR_Interface_t   InterfaceMode;  /*!<  Flash Interface mode of Instance */
  TicTacToe_OSPI_NOR_Transfer_t    TransferRate;   /*!<  Flash Transfer mode of Instance  */
} OSPI_NOR_Ctx_t;

typedef struct
{
  TicTacToe_OSPI_NOR_Interface_t   InterfaceMode;      /*!<  Current Flash Interface mode */
  TicTacToe_OSPI_NOR_Transfer_t    TransferRate;       /*!<  Current Flash Transfer rate  */
} TicTacToe_OSPI_NOR_Init_t;
  /**
  * @}
  */
...
#define TicTacToe_OSPI_NOR_SPI_MODE             (TicTacToe_OSPI_NOR_Interface_t)MX25LM51245G_SPI_MODE      /* 1 Cmd Line, 1 Address Line and 1 Data Line    */
#define TicTacToe_OSPI_NOR_OPI_MODE             (TicTacToe_OSPI_NOR_Interface_t)MX25LM51245G_OPI_MODE      /* 8 Cmd Lines, 8 Address Lines and 8 Data Lines */

/* Definition for OSPI transfer rates */
#define TicTacToe_OSPI_NOR_STR_TRANSFER         (TicTacToe_OSPI_NOR_Transfer_t)MX25LM51245G_STR_TRANSFER   /* Single Transfer Rate */
#define TicTacToe_OSPI_NOR_DTR_TRANSFER         (TicTacToe_OSPI_NOR_Transfer_t)MX25LM51245G_DTR_TRANSFER   /* Double Transfer Rate */

/* OSPI erase types */
#define TicTacToe_OSPI_NOR_ERASE_4K             MX25LM51245G_ERASE_4K
#define TicTacToe_OSPI_NOR_ERASE_64K            MX25LM51245G_ERASE_64K
#define TicTacToe_OSPI_NOR_ERASE_CHIP           MX25LM51245G_ERASE_BULK

/* OSPI block sizes */
#define TicTacToe_OSPI_NOR_BLOCK_4K             MX25LM51245G_SUBSECTOR_4K
#define TicTacToe_OSPI_NOR_BLOCK_64K            MX25LM51245G_SECTOR_64K
/**
  * @}
  */
