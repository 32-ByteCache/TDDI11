/**
  ...
  *          discovery board.
  ...
  -----------------------
   ...
   + Call the function TicTacToe_AUDIO_OUT_Init() for AUDIO OUT initialization: 
      ...
      GPIOs, DMA and interrupt if needed). This function returns TicTacToe_ERROR_NONE if configuration is OK.
      If the returned value is different from TicTacToe_ERROR_NONE or the function is stuck then the communication with
      ...
      by calling TicTacToe_AUDIO_OUT_RegisterMspCallbacks() function.
      User can restore the default MSP configuration by calling TicTacToe_AUDIO_OUT_RegisterDefaultMspCallbacks().
      To use these two functions, user has to enable USE_HAL_SAI_REGISTER_CALLBACKS within stm32l5xx_hal_conf.h file.

   + Call the function TicTacToe_AUDIO_OUT_Play() to play audio stream:
        Instance : Select the output instance. Can only be 0 (SAI).
        pBuf: pointer to the audio data file address.
        NbrOfBytes: Total size of the buffer to be sent in Bytes.

   + Call the function TicTacToe_AUDIO_OUT_Pause() to pause playing.
   + Call the function TicTacToe_AUDIO_OUT_Resume() to resume playing.
       Note. After calling TicTacToe_AUDIO_OUT_Pause() function for pause, only TicTacToe_AUDIO_OUT_Resume() should be called
          for resume (it is not allowed to call TicTacToe_AUDIO_OUT_Play() in this case).
       Note. This function should be called only when the audio file is played or paused (not stopped).
   + Call the function TicTacToe_AUDIO_OUT_Stop() to stop playing.
   + Call the function TicTacToe_AUDIO_OUT_Mute() to mute the player.
   + Call the function TicTacToe_AUDIO_OUT_UnMute() to unmute the player.
   + Call the function TicTacToe_AUDIO_OUT_IsMute() to get the mute state(TicTacToe_AUDIO_MUTE_ENABLED or TicTacToe_AUDIO_MUTE_DISABLED).
   + Call the function TicTacToe_AUDIO_OUT_SetDevice() to update the AUDIO OUT device.
   + Call the function TicTacToe_AUDIO_OUT_GetDevice() to get the AUDIO OUT device.
   + Call the function TicTacToe_AUDIO_OUT_SetSampleRate() to update the AUDIO OUT sample rate.
   + Call the function TicTacToe_AUDIO_OUT_GetSampleRate() to get the AUDIO OUT sample rate.
   + Call the function TicTacToe_AUDIO_OUT_SetBitsPerSample() to update the AUDIO OUT resolution.
   + Call the function TicTacToe_AUDIO_OUT_GetBitPerSample() to get the AUDIO OUT resolution.
   + Call the function TicTacToe_AUDIO_OUT_SetChannelsNbr() to update the AUDIO OUT number of channels.
   + Call the function TicTacToe_AUDIO_OUT_GetChannelsNbr() to get the AUDIO OUT number of channels.
   + Call the function TicTacToe_AUDIO_OUT_SetVolume() to update the AUDIO OUT volume.
   + Call the function TicTacToe_AUDIO_OUT_GetVolume() to get the AUDIO OUT volume.
   + Call the function TicTacToe_AUDIO_OUT_GetState() to get the AUDIO OUT state.

   + TicTacToe_AUDIO_OUT_SetDevice(), TicTacToe_AUDIO_OUT_SetSampleRate(), TicTacToe_AUDIO_OUT_SetBitsPerSample() and
     TicTacToe_AUDIO_OUT_SetChannelsNbr() cannot be called while the state is AUDIO_OUT_STATE_PLAYING.
   ...
   + Call the function TicTacToe_AUDIO_IN_Init() for AUDIO IN initialization: 
      ...
      User can override the default MSP configuration and register his own MSP callbacks (defined at application level)
      by calling TicTacToe_AUDIO_IN_RegisterMspCallbacks() function.
      User can restore the default MSP configuration by calling TicTacToe_AUDIO_IN_RegisterDefaultMspCallbacks().
   ...
   + Call the function TicTacToe_AUDIO_IN_Record() to record audio stream. The recorded data are stored to user buffer in raw
        (L, R, L, R ...).
        Instance : Select the input instance. Can be 0 (SAI) or 1 (DFSDM).
        pBuf: pointer to user buffer.
        NbrOfBytes: Total size of the buffer to be sent in Bytes.

   + Call the function TicTacToe_AUDIO_IN_Pause() to pause recording.
   + Call the function TicTacToe_AUDIO_IN_Resume() to resume recording.
   + Call the function TicTacToe_AUDIO_IN_Stop() to stop recording.
   + Call the function TicTacToe_AUDIO_IN_SetDevice() to update the AUDIO IN device.
   + Call the function TicTacToe_AUDIO_IN_GetDevice() to get the AUDIO IN device.
   + Call the function TicTacToe_AUDIO_IN_SetSampleRate() to update the AUDIO IN sample rate.
   + Call the function TicTacToe_AUDIO_IN_GetSampleRate() to get the AUDIO IN sample rate.
   + Call the function TicTacToe_AUDIO_IN_SetBitPerSample() to update the AUDIO IN resolution.
   + Call the function TicTacToe_AUDIO_IN_GetBitPerSample() to get the AUDIO IN resolution.
   + Call the function TicTacToe_AUDIO_IN_SetChannelsNbr() to update the AUDIO IN number of channels.
   + Call the function TicTacToe_AUDIO_IN_GetChannelsNbr() to get the AUDIO IN number of channels.
   + Call the function TicTacToe_AUDIO_IN_SetVolume() to update the AUDIO IN volume.
   + Call the function TicTacToe_AUDIO_IN_GetVolume() to get the AUDIO IN volume.
   + Call the function TicTacToe_AUDIO_IN_GetState() to get the AUDIO IN state.
...
int32_t Audio_DigMicRecBuff[TicTacToe_AUDIO_IN_DEFAULT_BUFFER_SIZE];
/**
  * @}
  */
...
/**
  ...
  */
int32_t TicTacToe_AUDIO_OUT_Init(uint32_t Instance, TicTacToe_AUDIO_Init_t *AudioInit)
{
  ...
  else
  {
    ...
    if (Audio_In_Ctx[0].State == AUDIO_IN_STATE_RESET)
    {
      if (CS42L51_Probe() != TicTacToe_ERROR_NONE)
      {
    ...
    if (status == TicTacToe_ERROR_NONE)
    {
      ...
      if ((Audio_In_Ctx[0].State == AUDIO_IN_STATE_RESET) && (Audio_In_Ctx[1].State == AUDIO_IN_STATE_RESET))
      {
        ...
        {
          status = TicTacToe_ERROR_CLOCK_FAILURE;
        }
      }
      ...
      if (status == TicTacToe_ERROR_NONE)
      {
        ...
        {
          if (TicTacToe_AUDIO_OUT_RegisterDefaultMspCallbacks(Instance) != TicTacToe_ERROR_NONE)
          {
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_DeInit(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_Play(uint32_t Instance, uint8_t* pData, uint32_t NbrOfBytes)
{
  int32_t  status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_Pause(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_Resume(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_Stop(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_Mute(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_UnMute(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_IsMute(uint32_t Instance, uint32_t *IsMute)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_SetVolume(uint32_t Instance, uint32_t Volume)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_GetVolume(uint32_t Instance, uint32_t *Volume)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_SetSampleRate(uint32_t Instance, uint32_t SampleRate)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_GetSampleRate(uint32_t Instance, uint32_t *SampleRate)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_SetDevice(uint32_t Instance, uint32_t Device)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_GetDevice(uint32_t Instance, uint32_t *Device)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_SetBitsPerSample(uint32_t Instance, uint32_t BitsPerSample)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_GetBitsPerSample(uint32_t Instance, uint32_t *BitsPerSample)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_SetChannelsNbr(uint32_t Instance, uint32_t ChannelNbr)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_GetChannelsNbr(uint32_t Instance, uint32_t *ChannelNbr)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_GetState(uint32_t Instance, uint32_t *State)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
#if (USE_HAL_SAI_REGISTER_CALLBACKS == 1)
/**
  * @brief  Register default TicTacToe AUDIO OUT msp callbacks.
  * @param  Instance AUDIO OUT Instance.
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_OUT_RegisterDefaultMspCallbacks(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  * @brief  Register TicTacToe AUDIO OUT msp callbacks.
  * @param  Instance AUDIO OUT Instance.
  * @param  CallBacks Pointer to MspInit/MspDeInit callback functions.
  * @retval TicTacToe status
  */
int32_t TicTacToe_AUDIO_OUT_RegisterMspCallbacks(uint32_t Instance, TicTacToe_AUDIO_OUT_Cb_t *CallBacks)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval None.
  */
__weak void TicTacToe_AUDIO_OUT_TransferComplete_CallBack(uint32_t Instance)
{
...
/**
  ...
  * @retval None.
  */
__weak void TicTacToe_AUDIO_OUT_HalfTransfer_CallBack(uint32_t Instance)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Instance);
}
...
/**
  ...
  * @retval None.
  */
__weak void TicTacToe_AUDIO_OUT_Error_CallBack(uint32_t Instance)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Instance);
}
...
/**
  * @brief  TicTacToe AUDIO OUT interrupt handler.
  * @param  Instance Audio out instance.
  * @param  Device Device of the audio out stream.
  * @retval None.
  */
void TicTacToe_AUDIO_OUT_IRQHandler(uint32_t Instance, uint32_t Device)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Instance);
  UNUSED(Device);
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_Init(uint32_t Instance, TicTacToe_AUDIO_Init_t *AudioInit)
{
  int32_t status = TicTacToe_ERROR_NONE;
    ...
    if (Instance == 0U)
    {
      ...
      if (status == TicTacToe_ERROR_NONE)
      {
        ...
        if (status == TicTacToe_ERROR_NONE)
        {
          ...
          {
            if (TicTacToe_AUDIO_IN_RegisterDefaultMspCallbacks(Instance) != TicTacToe_ERROR_NONE)
            {
              status = TicTacToe_ERROR_PERIPH_FAILURE;
            }
          }
          if (Audio_Out_Ctx[0].State == AUDIO_OUT_STATE_RESET)
          {
            ...
            {
              if (TicTacToe_AUDIO_OUT_RegisterDefaultMspCallbacks(0) != TicTacToe_ERROR_NONE)
              {
                status = TicTacToe_ERROR_PERIPH_FAILURE;
              }
            }
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_DeInit(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
  ...
  else if (Audio_In_Ctx[Instance].State != AUDIO_IN_STATE_RESET)
  {
    ...
    else /* Instance = 1 */
    {
      ...
      if (DFSDM_DeInit(&haudio_in_dfsdm_filter, &haudio_in_dfsdm_channel) != TicTacToe_ERROR_NONE)
      {
        status = TicTacToe_ERROR_PERIPH_FAILURE;
      }
      else
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_Record(uint32_t Instance, uint8_t* pData, uint32_t NbrOfBytes)
{
  int32_t  status = TicTacToe_ERROR_NONE;
  ...
  else if ((Instance == 1U) && ((NbrOfBytes / 2U) > TicTacToe_AUDIO_IN_DEFAULT_BUFFER_SIZE))
  {
    status = TicTacToe_ERROR_WRONG_PARAM;
  }
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_Pause(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_Resume(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_Stop(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_SetVolume(uint32_t Instance, uint32_t Volume)
{
  int32_t status;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_GetVolume(uint32_t Instance, uint32_t *Volume)
{
  int32_t status;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_SetSampleRate(uint32_t Instance, uint32_t SampleRate)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_GetSampleRate(uint32_t Instance, uint32_t *SampleRate)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_SetDevice(uint32_t Instance, uint32_t Device)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_GetDevice(uint32_t Instance, uint32_t *Device)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_SetBitsPerSample(uint32_t Instance, uint32_t BitsPerSample)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_GetBitsPerSample(uint32_t Instance, uint32_t *BitsPerSample)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_SetChannelsNbr(uint32_t Instance, uint32_t ChannelNbr)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_GetChannelsNbr(uint32_t Instance, uint32_t *ChannelNbr)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_GetState(uint32_t Instance, uint32_t *State)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
#if ((USE_HAL_DFSDM_REGISTER_CALLBACKS == 1) || (USE_HAL_SAI_REGISTER_CALLBACKS == 1))
/**
  * @brief  Register default TicTacToe AUDIO IN msp callbacks.
  * @param  Instance AUDIO IN Instance.
  * @retval TicTacToe status.
  */
int32_t TicTacToe_AUDIO_IN_RegisterDefaultMspCallbacks(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  * @brief  Register TicTacToe AUDIO IN msp callbacks.
  * @param  Instance AUDIO IN Instance.
  * @param  CallBacks Pointer to MspInit/MspDeInit callback functions.
  * @retval TicTacToe status
  */
int32_t TicTacToe_AUDIO_IN_RegisterMspCallbacks(uint32_t Instance, TicTacToe_AUDIO_IN_Cb_t *CallBacks)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval None.
  */
__weak void TicTacToe_AUDIO_IN_TransferComplete_CallBack(uint32_t Instance)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Instance);
}
...
/**
  ...
  * @retval None.
  */
__weak void TicTacToe_AUDIO_IN_HalfTransfer_CallBack(uint32_t Instance)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Instance);
}
...
/**
  ...
  * @retval None.
  */
__weak void TicTacToe_AUDIO_IN_Error_CallBack(uint32_t Instance)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Instance);
}
...
/**
  * @brief  TicTacToe AUDIO IN interrupt handler.
  * @param  Instance Audio in instance.
  * @param  Device Device of the audio in stream.
  * @retval None.
  */
void TicTacToe_AUDIO_IN_IRQHandler(uint32_t Instance, uint32_t Device)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(Device);
...
static void SAI_MspInit(SAI_HandleTypeDef *hsai)
{
  ...
  if (hsai->Instance == SAI1_Block_A)
  {
    ...
    HAL_NVIC_SetPriority(DMA2_Channel1_IRQn, TicTacToe_AUDIO_OUT_IT_PRIORITY, 0);
  ...
  else /* SAI1_BlockB */
  {
    ...
    /* SAI DMA IRQ Channel configuration */
    HAL_NVIC_SetPriority(DMA2_Channel2_IRQn, TicTacToe_AUDIO_IN_IT_PRIORITY, 0);
...
static void SAI_TxCpltCallback(SAI_HandleTypeDef *hsai)
{
  if (hsai->Instance == SAI1_Block_A)
  {
    TicTacToe_AUDIO_OUT_TransferComplete_CallBack(0);
  }
}
...
static void SAI_TxHalfCpltCallback(SAI_HandleTypeDef *hsai)
{
  if (hsai->Instance == SAI1_Block_A)
  {
    TicTacToe_AUDIO_OUT_HalfTransfer_CallBack(0);
  }
}
...
static void SAI_RxCpltCallback(SAI_HandleTypeDef *hsai)
{
  ...
  {
    TicTacToe_AUDIO_IN_TransferComplete_CallBack(0);
  }
}
...
static void SAI_RxHalfCpltCallback(SAI_HandleTypeDef *hsai)
{
  if (hsai->Instance == SAI1_Block_B)
  {
    TicTacToe_AUDIO_IN_HalfTransfer_CallBack(0);
  }
}
...
static void SAI_ErrorCallback(SAI_HandleTypeDef *hsai)
{
  if (hsai->Instance == SAI1_Block_A)
  {
    TicTacToe_AUDIO_OUT_Error_CallBack(0);
  }
  if (hsai->Instance == SAI1_Block_B)
  {
    TicTacToe_AUDIO_IN_Error_CallBack(0);
  }
}
...
static void DFSDM_FilterMspInit(DFSDM_Filter_HandleTypeDef *hdfsdm_filter)
{
  if(hdfsdm_filter->Instance == DFSDM1_Filter0)
  {
    ...
    HAL_NVIC_SetPriority(DMA1_Channel4_IRQn, TicTacToe_AUDIO_IN_IT_PRIORITY, 0);
...
static void DFSDM_FilterRegConvCpltCallback(DFSDM_Filter_HandleTypeDef *hdfsdm_filter)
{
  ...
  TicTacToe_AUDIO_IN_TransferComplete_CallBack(1);
}
...
static void DFSDM_FilterRegConvHalfCpltCallback(DFSDM_Filter_HandleTypeDef *hdfsdm_filter)
{
  ...
  TicTacToe_AUDIO_IN_HalfTransfer_CallBack(1);
}
...
static void DFSDM_FilterErrorCallback(DFSDM_Filter_HandleTypeDef *hdfsdm_filter)
{
  ...
  TicTacToe_AUDIO_IN_Error_CallBack(1);
}
