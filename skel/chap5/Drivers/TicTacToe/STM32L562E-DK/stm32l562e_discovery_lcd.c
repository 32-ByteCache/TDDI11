  ...
  *          mounted on STM32L562E-DISCOVERY board.
  ...
  ----------------------
    + Initialization steps:
       o Initialize the LCD using the TicTacToe_LCD_Init() function. You can select
         ...
         rotation).
       o Call TicTacToe_LCD_GetXSize() and TicTacToe_LCD_GetYsize() to get respectively
         width and height in pixels of LCD in the current orientation.
       o Call TicTacToe_LCD_SetBrightness() and TicTacToe_LCD_GetBrightness() to
         respectively set and get LCD brightness.
       o Call TicTacToe_LCD_SetActiveLayer() to select the current active layer.
       o Call TicTacToe_LCD_GetFormat() to get LCD pixel format supported.

    + Display on LCD:
       o Call TicTacToe_LCD_DisplayOn() and TicTacToe_LCD_DisplayOff() to respectively
         switch on and switch off the LCD display.
       o Call TicTacToe_LCD_WritePixel() and TicTacToe_LCD_ReadPixel() to respectively write
         and read a pixel.
       o Call TicTacToe_LCD_DrawHLine() to draw a horizontal line.
       o Call TicTacToe_LCD_DrawVLine() to draw a vertical line.
       o Call TicTacToe_LCD_DrawBitmap() to draw a bitmap.
       o Call TicTacToe_LCD_FillRect() to draw a rectangle.
       o Call TicTacToe_LCD_FillRGBRect() to draw a rectangle with RGB buffer.

    + De-initialization steps:
       o De-initialize the LCD using the TicTacToe_LCD_DeInit() function.
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_LCD_DeInit(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_LCD_DisplayOff(uint32_t Instance)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_LCD_SetBrightness(uint32_t Instance, uint32_t Brightness)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status.
  */
int32_t TicTacToe_LCD_GetBrightness(uint32_t Instance, uint32_t *Brightness)
{
  int32_t status = TicTacToe_ERROR_NONE;
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_LCD_RegisterDefaultMspCallbacks(uint32_t Instance)
{
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_LCD_RegisterMspCallbacks(uint32_t Instance, TicTacToe_LCD_Cb_t *Callback)
{
  int32_t ret = TicTacToe_ERROR_NONE;
...
static int32_t LCD_FMC_Init(void)
{
  ...
  if (HAL_SRAM_GetState(&hlcd_sram[0]) == HAL_SRAM_STATE_RESET)
  {
    ...
    {
      if (TicTacToe_LCD_RegisterDefaultMspCallbacks(0) != TicTacToe_ERROR_NONE)
      {
