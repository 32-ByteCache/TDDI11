/**
  ...
  * @brief   This example code shows how to use the TicTacToe SD Driver
  ******************************************************************************
  * @attention
  *
...
//void SD_demo(void)
//{
//  int32_t SD_state = TicTacToe_ERROR_NONE;
//  static uint8_t prev_status = 2;  /* Undefined state */
//
//  SD_SetHint();
//
//  SD_state = TicTacToe_SD_Init(0);
//
//#if (SD_CARD_PRESENCE_VALIDATION_MODE == SD_CARD_PRESENCE_INTERRUPT_MODE)
//  if (SD_state == TicTacToe_ERROR_NONE)
//  {
//    SD_state = TicTacToe_SD_DetectITConfig(0);
//  }
//#endif
//
//  if (SD_state != TicTacToe_ERROR_NONE)
//  {
//    if (SD_state == TicTacToe_ERROR_UNKNOWN_COMPONENT)
//    {
...
//
//    SD_state = TicTacToe_SD_Erase(0, BLOCK_START_ADDR, (BLOCKSIZE * NUM_OF_BLOCKS));
//
//    /* Wait until SD card is ready to use for new operation */
//    while (TicTacToe_SD_GetCardState(0) != SD_TRANSFER_OK)
//    {
//    }
//
//    if (SD_state != TicTacToe_ERROR_NONE)
...
//      SD_state = TicTacToe_SD_WriteBlocks_DMA(0, aTxBuffer, BLOCK_START_ADDR, NUM_OF_BLOCKS);
//
...
//        SD_state = TicTacToe_SD_ReadBlocks_DMA(0, aRxBuffer, BLOCK_START_ADDR, NUM_OF_BLOCKS);
//
