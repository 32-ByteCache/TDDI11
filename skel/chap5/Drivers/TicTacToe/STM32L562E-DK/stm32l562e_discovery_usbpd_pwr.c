...
/**
  ******************************************************************************
  * @file    stm32l562e_discovery_usbpd_pwr.c
...
/* Includes ------------------------------------------------------------------*/
#include "stm32l562e_discovery_usbpd_pwr.h"
...
/** @defgroup STM32L562E-DK_USBPD_PWR STM32L562E-DK USBPD POWER
  * @{
  */

/** @defgroup STM32L562E-DK_USBPD_PWR_Private_Typedef STM32L562E-DK USBPD POWER Private Typedef
  * @{
  */
...
/** @defgroup STM32L562E-DK_USBPD_PWR_Private_Constants STM32L562E-DK USBPD POWER Private Constants
* @{
*/
...
/** @defgroup STM32L562E-DK_USBPD_PWR_Private_Macros STM32L562E-DK USBPD POWER Private Macros
  * @{
  */
...
/** @defgroup STM32L562E-DK_USBPD_PWR_Private_Variables STM32L562E-DK USBPD POWER Private Variables
  * @{
  */
...
/** @defgroup STM32L562E-DK_USBPD_PWR_Private_Functions STM32L562E-DK USBPD POWER Private Functions
  * @{
  */
...
/** @defgroup STM32L562E-DK_USBPD_PWR_Exported_Variables STM32L562E-DK USBPD POWER Exported Variables
  * @{
  */
...
/** @addtogroup STM32L562E-DK_USBPD_PWR_Exported_Functions
  * @{
  */
...
/**
  ...
  */
int32_t TicTacToe_USBPD_PWR_Init(uint32_t Instance)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_Init */
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_Init */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_Deinit(uint32_t Instance)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_Deinit */
  /* Check if instance is valid       */
  int32_t ret = TicTacToe_ERROR_NONE;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_Deinit */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSInit(uint32_t Instance)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSInit */
  /* Check if instance is valid       */
  int32_t ret = TicTacToe_ERROR_NONE;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSInit */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSDeInit(uint32_t Instance)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSDeInit */
  /* Check if instance is valid       */
  int32_t ret;
  ...
  {
    ret = TicTacToe_ERROR_FEATURE_NOT_SUPPORTED;
  }
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSDeInit */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSOn(uint32_t Instance)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSOn */
  /* Check if instance is valid       */
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSOn */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSOff(uint32_t Instance)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSOff */
  /* Check if instance is valid       */
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSOff */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSSetVoltage_Fixed(uint32_t Instance,
                                           uint32_t VbusTargetInmv,
                                           uint32_t OperatingCurrent,
                                           uint32_t MaxOperatingCurrent)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSSetVoltage_Fixed */
  /* Check if instance is valid       */
  int32_t ret = TicTacToe_ERROR_NONE;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSSetVoltage_Fixed */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSSetVoltage_Variable(uint32_t Instance,
                                              uint32_t VbusTargetMinInmv,
                                              uint32_t VbusTargetMaxInmv,
                                              uint32_t OperatingCurrent,
                                              uint32_t MaxOperatingCurrent)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSSetVoltage_Variable */
  /* Check if instance is valid       */
  int32_t ret;
  UNUSED(MaxOperatingCurrent);
  UNUSED(OperatingCurrent);
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSSetVoltage_Variable */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSSetVoltage_Battery(uint32_t Instance,
                                             uint32_t VbusTargetMin,
                                             uint32_t VbusTargetMax,
                                             uint32_t OperatingPower,
                                             uint32_t MaxOperatingPower)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSSetVoltage_Battery */
  /* Check if instance is valid       */
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSSetVoltage_Battery */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSSetVoltage_APDO(uint32_t Instance,
                                          uint32_t VbusTargetInmv,
                                          uint32_t OperatingCurrent,
                                          int32_t Delta)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSSetVoltage_APDO */
  /* Check if instance is valid       */
  int32_t ret;
  UNUSED(Delta);
  UNUSED(OperatingCurrent);
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSSetVoltage_APDO */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSGetVoltage(uint32_t Instance, uint32_t *pVoltage)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSGetVoltage */
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSGetVoltage */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSGetCurrent(uint32_t Instance, int32_t *pCurrent)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSGetCurrent */
  /* Check if instance is valid       */
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSGetCurrent */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VCONNInit(uint32_t Instance,
                                uint32_t CCPinId)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VCONNInit */
  /* Check if instance is valid       */
  UNUSED(CCPinId);
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VCONNInit */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VCONNDeInit(uint32_t Instance,
                                  uint32_t CCPinId)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VCONNDeInit */
  /* Check if instance is valid       */
  UNUSED(CCPinId);
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VCONNDeInit */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VCONNOn(uint32_t Instance,
                              uint32_t CCPinId)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VCONNOn */
  /* Check if instance is valid       */
  UNUSED(CCPinId);
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VCONNOn */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VCONNOff(uint32_t Instance,
                               uint32_t CCPinId)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VCONNOff */
  /* Check if instance is valid       */
  UNUSED(CCPinId);
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VCONNOff */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VCONNIsOn(uint32_t Instance,
                                uint32_t CCPinId, uint8_t *pState)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VCONNIsOn */
  /* Check if instance is valid       */
  UNUSED(CCPinId);
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VCONNIsOn */
}

/**
  * @brief  Set the VBUS disconnection voltage threshold.
  * @note   Callback function registered through TicTacToe_USBPD_PWR_RegisterVBUSDetectCallback
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_SetVBUSDisconnectionThreshold(uint32_t Instance,
                                                    uint32_t VoltageThreshold)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_SetVBUSDisconnectionThreshold */
  /* Check if instance is valid       */
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_SetVBUSDisconnectionThreshold */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_RegisterVBUSDetectCallback(uint32_t Instance,
                                                 USBPD_PWR_VBUSDetectCallbackFunc *pfnVBUSDetectCallback)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_RegisterVBUSDetectCallback */
  /* Check if instance is valid       */
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_RegisterVBUSDetectCallback */
}
...
/**
  ...
  * @retval TicTacToe status
  */
int32_t TicTacToe_USBPD_PWR_VBUSIsOn(uint32_t Instance, uint8_t *pState)
{
  /* USER CODE BEGIN TicTacToe_USBPD_PWR_VBUSIsOn */
  /* Check if instance is valid       */
  UNUSED(pState);
  int32_t ret;
  ...
  return ret;
  /* USER CODE END TicTacToe_USBPD_PWR_VBUSIsOn */
}
...
/** @addtogroup STM32L562E-DK_USBPD_PWR_Private_Functions
  * @{
  */
