...
#define IDD_PRE_DELAY_MAX                  30000UL  /*!< Maximum value in millisecond before starting acquisition. This is the default configuration after TicTacToe_IDD_Init (unit: ms). */
#define IDD_ACQUISITION_DURATION_MIN       1UL      /*!< Minimum duration of the acquisation (unit: ms). */
#define IDD_ACQUISITION_DURATION_MAX       10000UL  /*!< Maximum duration of the acquisation. This is the default configuration after TicTacToe_IDD_Init (unit: ms). */
#define IDD_VOLTAGE_MIN                    1800UL   /*!< Minimum power supply voltage level of the MCU Vdd (unit: mV). */
#define IDD_VOLTAGE_MAX                    3300UL   /*!< Maximum power supply voltage level of the MCU Vdd . This is the default configuration after TicTacToe_IDD_Init (unit: mV). */
/**
  * @}
  */
...
typedef struct
{
  ...
  TicTacToe_IDD_Config_t    IddConfig;
...
int32_t   TicTacToe_IDD_GetValue(uint32_t Instance, uint32_t *IddValue);
...
void      TicTacToe_IDD_Callback(uint32_t Instance);
